...
namespace Donker.Extensions.ExtensionMethods.HttpRequestBaseExtensions
{
    ...
    {
        /// <summary>
        /// Checks if the client browser version is lower than the specified version.
        /// </summary>
        ...
        /// <param name="majorVersion">The browser major version should be lower than this major version, if a minor version is not specified.</param>
        /// <param name="minorVersion">The browser minor version should be lower than this minor version, if specified.</param>
        /// <returns><c>1</c> if lesser; <c>0</c> if equal, greater or different browser; <c>-1</c> if unknown.</returns>
        ...
        public static int BrowserLesserThan(this HttpRequestBase request, string browserName, int majorVersion, double? minorVersion)
        {
            if (browserName == null)
        ...
        /// <param name="request">The request containing the browser information.</param>
        /// <param name="browserName">The name of the browser to check the version for.</param>
        /// <param name="majorVersion">The browser major version should be lower than this major version.</param>
        /// <returns><c>1</c> if lesser; <c>0</c> if equal, greater or different browser; <c>-1</c> if unknown.</returns>
        /// <exception cref="ArgumentNullException"><see cref="browserName"/> is null.</exception>
        /// <exception cref="ArgumentException"><see cref="browserName"/> is empty.</exception>
        public static int BrowserLesserThan(this HttpRequestBase request, string browserName, int majorVersion)
        {
            return BrowserLesserThan(request, browserName, majorVersion, null);
        }
    }
}